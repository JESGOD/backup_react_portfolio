...
export function NavBar() {
  return (
    <>
        ...
        <nav class=" text-white font-gruppo relative px-4 py-4 flex justify-between items-center " >
          <a class="text-2xl font-bold leading-none" href="#">
            <span className=" tracking-widest ">JESGOD</span>
          </a>
          <div class="lg:hidden">
          ...
          <ul class="text-lg text-white hidden absolute top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2 lg:flex lg:mx-auto lg:items-center lg:w-auto lg:space-x-6">
            <li>
